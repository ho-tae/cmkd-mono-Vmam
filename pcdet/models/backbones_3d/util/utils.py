...
from .norm import NaiveSyncBatchNorm1d, NaiveSyncBatchNorm2d, NaiveSyncBatchNorm3d
...
class VFELayer(nn.Module):
    ...
    def __init__(self,
        ...
        print('create hard')
        #if norm_cfg.type == 'naiveSyncBN1d':
        #    self.norm = NaiveSyncBatchNorm1d(norm_cfg, out_channels)[1]
        #elif norm_cfg.type == 'naiveSyncBN2d':
        #    self.norm = NaiveSyncBatchNorm2d(norm_cfg, out_channels)[1]
        #elif norm_cfg.type == 'naiveSyncBN3d':
        #    self.norm = NaiveSyncBatchNorm3d(norm_cfg, out_channels)[1]    
        #else:    
